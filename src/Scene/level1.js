...
// da sistemaer il lieve lag della piattaforma mobile fnale rispetto alla pressione pedana
...
function create (s) {
    ...
    pedana2 = PP.shapes.rectangle_add(s, 12100, 1713, 150, 40, "0xfbc456", 1);
    ...
    create_piatt_move (s, 11900, 1695);
    ...
    for (let g = 0; g < casse.length; g++) {
        PP.physics.add_collider_f(s, casse[g], pedana1, apertura_porta1);
    }
